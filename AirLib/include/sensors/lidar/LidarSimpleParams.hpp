...
namespace airlib
{
    ...
    struct LidarSimpleParams
    {
        ...
        void initializeFromSettings(const AirSimSettings::LidarSetting& settings)
        {
            ...
            azimuth_stddev = settings_json.getFloat("AzimuthStdDev", azimuth_stddev);
            polar_stddev = settings_json.getFloat("PolarStdDev", polar_stddev);
            range_stddev = settings_json.getFloat("RangeStdDev", range_stddev);
            point_loss_likelihood = settings_json.getFloat("PointLossLikelihood", point_loss_likelihood);
            random_return_likelihood = settings_json.getFloat("RandomReturnLikelihood", random_return_likelihood);
            update_frequency = settings_json.getFloat("SensorUpdateFrequency", update_frequency);
