...
public:
	...
	virtual void saveVideoCameraImages(const std::vector<ImageCaptureBase::ImageResponse>& responses) = 0;
	virtual void getVideoCameraImages(std::vector<ImageCaptureBase::ImageResponse> & responses) = 0;
