...
namespace airlib
{
    ...
    protected:
        ...
        {
            typedef simple_flight::GoalModeType GoalModeType;
            simple_flight::GoalMode mode(GoalModeType::AccelerationWorld, GoalModeType::AccelerationWorld, yaw_mode.is_rate ? GoalModeType::AngleRate : GoalModeType::AngleLevel, GoalModeType::AccelerationWorld);
